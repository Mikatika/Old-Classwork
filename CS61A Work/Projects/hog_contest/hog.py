...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    pigged, cur_roll, total, count = 0, 0, 0, 0
...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    count = 1
    while count <= min(player_score, opponent_score):
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    """
    # BEGIN PROBLEM 9
    count, top_dice, top_score = 1, 1, 1
    while count <= 10:
        avgdice = make_averaged(roll_dice,trials_count)
        curr_score = avgdice(count, dice)
        print('dice:', count, 'average:', curr_score)
...
def extra_turn_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if extra_turn(score + bacon, opponent_score) or bacon >= cutoff:
        return 0
    return num_rolls
    # END PROBLEM 11


def final_strategy(score, opponent_score, cutoff = 8, num_rolls = 4):
    """Write a brief description of your final strategy.

    if score + 1 gives extra turn, roll big
    """
    # BEGIN PROBLEM 12
